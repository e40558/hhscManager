...
var RSA_PRIVATE_KEY = fs.readFileSync('./ssl/private.key');
var RSA_PUBLIC_KEY = fs.readFileSync('./ssl/public.key');
var SESSION_DURATION = 240;
function createSessionToken(userId) {
    return (0, exports.signJwt)({}, RSA_PRIVATE_KEY, {
        algorithm: 'RS256',
        expiresIn: 240,
        subject: userId
    });
...
function createCsrfToken() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, exports.randomBytes)(32).then(function (bytes) { return bytes.toString("hex"); })];
